...
public class ChatSet {
    public static FileSet fileSet = new FileSet("chatSet.yml");
    ...
    public ChatSet(Player player) {
        ...
        self = player;
        if (!fileSet.data.getKeys(true).contains(player.getUniqueId().toString())){
            fileSet.data.set(player.getUniqueId()+".type","player");
    ...
    public void saveChatSet() {
        ...
        fileSet.data.set(prefix+"CustomName",CustomName);
        fileSet.data.set(prefix+"ContentColor",ContentColor.name());
        fileSet.data.set(prefix+"NameColor",NameColor.name());
        fileSet.data.set(prefix+"DiscordName",discordName);
        fileSet.save();
    }
